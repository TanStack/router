...
Read [comparable measurements](references/checks.md#comparable-measurements) for every measurement, then the applicable sections below. Combine sections when a change crosses boundaries.

| Mechanism                                                      | Reference                                                                                                                                                                                                    |
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Runtime work, cleanup, hydration, RSC, or devtools             | [Runtime and lifecycle checks](references/checks.md#runtime-and-lifecycle-checks); for live requests/rendering, also [browser and server measurements](references/checks.md#browser-and-server-measurements) |
| Compiler work, maps, diagnostics, metadata, or module identity | [Build-tool checks](references/checks.md#build-tool-checks)                                                                                                                                                  |
| Hot updates, route deletion, or watcher replacement            | [HMR and watch lifetimes](references/checks.md#hmr-and-watch-lifetimes) and the affected runtime/build checks                                                                                                |
| Dependency versions or bundler compatibility                   | [Dependency upgrades](references/checks.md#dependency-upgrades) and the affected adapter checks                                                                                                              |
| Vendor/runtime chunks or deployment recovery                   | [Chunk caching and deployment recovery](references/checks.md#chunk-caching-and-deployment-recovery)                                                                                                          |
| TypeScript inference or compiler cost                          | [TypeScript cost](references/checks.md#typescript-cost)                                                                                                                                                      |
