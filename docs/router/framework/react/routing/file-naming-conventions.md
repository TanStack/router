...
| **`-` Prefix**                     | Files and folders with the `-` prefix are excluded from the routing logic. They would not be added to `routeTree.gen.ts` file and can be used to colocate logic in route folders.                                                                                                                                                                                               |
