...
- Type: `(opts?: {filter?: (d: MakeRouteMatchUnion<TRouter>) => boolean, forceSyncLoaders?: boolean}) => Promise<void>`
...
- if `forceSyncLoaders` is true, the promise returned by this function will only resolve once all loaders have finished.
...
- Type: `(opts?: {forceSyncLoaders?: boolean}) => Promise<void>`
- if `forceSyncLoaders` is true, the promise returned by this function will only resolve once all loaders have finished.
