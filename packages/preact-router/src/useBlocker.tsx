...
export function useBlocker(
  ...
  const [resolver, setResolver] = useState<BlockerResolver>({
    status: 'idle',
    current: undefined,
    next: undefined,
    action: undefined,
...
export function Block<
  TRouter extends AnyRouter = RegisteredRouter,
  TWithResolver extends boolean = boolean,
>(opts: PromptProps<TRouter, TWithResolver>): ComponentChildren
...
> = UseBlockerOpts<TRouter, TWithResolver> & {
  children?: ComponentChildren | ((params: TParams) => ComponentChildren)
}
