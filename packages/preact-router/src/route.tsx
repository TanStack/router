...
> extends BaseRouteApi<TId, TRouter> {
  ...
  // No forwardRef in Preact - Link is a plain function component
  Link: LinkComponentRoute<RouteTypesById<TRouter, TId>['fullPath']> =
    ((props: any) => {
      const router = useRouter()
      const fullPath = router.routesById[this.id as string].fullPath
      return h(Link as any, { from: fullPath as never, ...props })
    ...
    >
{
  ...
  constructor(
    ...
    super(options)
    // No $$typeof = Symbol.for('react.memo') - not needed for Preact
  }
  ...
  // No forwardRef in Preact - Link is a plain function component
  Link: LinkComponentRoute<TFullPath> = ((props: any) => {
    return h(Link as any, { from: this.fullPath as never, ...props })
    ...
    >
{
  ...
  // No forwardRef in Preact - Link is a plain function component
  Link: LinkComponentRoute<'/'> = ((props: any) => {
    return h(Link as any, { from: this.fullPath, ...props })
  }) as unknown as LinkComponentRoute<'/'>
}
...
export interface DefaultRouteTypes<TProps> {
  component: (props: TProps) => VNode | null
}
