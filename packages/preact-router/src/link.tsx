...
>(
  ...
  const handleClick = (e: JSX.TargetedMouseEvent<HTMLAnchorElement>) => {
    ...
    if (
      ...
      // Preact doesn't have flushSync, but setting state directly works
  ...
  // The click handler
  const handleFocus = (_: JSX.TargetedMouseEvent<HTMLAnchorElement>) => {
    if (disabled) return
    if (preload) {
      doPreload()
    }
  ...
  const handleEnter = (e: JSX.TargetedMouseEvent<HTMLAnchorElement>) => {
  ...
  const handleLeave = (e: JSX.TargetedMouseEvent<HTMLAnchorElement>) => {
  ...
  const resolvedStyle = (style ||
    ...
    ...(style as any),
    ...(resolvedActiveProps.style as any),
    ...(resolvedInactiveProps.style as any),
  }
...
export function createLink<const TComp>(
  ...
  return forwardRef(function CreatedLink(props, ref) {
    return <Link {...(props as any)} _asChild={Comp} ref={ref} />
  }) as any
}

export const Link: LinkComponent<'a'> = forwardRef<Element, any>(
  (props, ref) => {
...
function isCtrlEvent(e: JSX.TargetedMouseEvent<HTMLAnchorElement>) {
