...
declare module '@tanstack/router-core' {
  export interface RouterOptionsExtensions {
     ...
     *
     * @link [API Docs](https://tanstack.com/router/latest/docs/framework/preact/api/router/RouterOptionsType#wrap-property)
     */
     ...
     * Only non-DOM-rendering components like providers should be used, anything else will cause a hydration error.
     *
     * @link [API Docs](https://tanstack.com/router/latest/docs/framework/preact/api/router/RouterOptionsType#innerwrap-property)
     */
    InnerWrap?: (props: { children: any }) => any
