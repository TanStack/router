...
export type SameUrlDetection = 'hrefEquality' | 'deepComparison';

export type PreserveNavigationBehavior = 'noop' | 'reload';
...
> = {
  ...
  /**
   * Way to compare locations to detect same url
   * - hrefEquality - compare prev and next location.href
   * - deepComparison - compare prev and next location.href, location.state and masked locations href and state
   * */
  sameUrlDetection?: SameUrlDetection
  /**
   * What to do if navigation was preserved because of same url
   * - noop - do nothing
   * - reload - run loaders again
   * */
