...
describe('hydrating a server-capped boundary lane', () => {
  test.each([
    ...
    async (outcome, boundary) => {
      ...
      // Hydration reconstructs the boundary head once. Keep its second call,
      // from the follow-up boundary replay, pending so the first client frame
      // is observable instead of racing the final commit.
