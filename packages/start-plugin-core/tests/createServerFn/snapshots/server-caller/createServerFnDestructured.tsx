...
export const withArrowFunction = createServerFn({
  method: 'GET'
}).handler(createSsrRpc("a311dfd9a6554bc0bb9371ef4fbc72c852d0b5532829a2613a29157b8595a793"));
export const withArrowFunctionAndFunction = createServerFn({
  method: 'GET'
}).handler(createSsrRpc("dbe1f77c6ea7590bce3212a75b06d3cee83b425bcf493014cb47462ef725e36e"));
