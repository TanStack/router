const _Hydrate_ = _lazyHydratedComponent(() => import("/Users/caligano/source/tanstack/router/packages/start-plugin-core/tests/hydrateWhen/test-files/hydrateWhenBasic.tsx?tss-hydrate=hydrateWhenBasic_ea3b43bf45&tss-hydrate-index=0"), "Hydrate_0"),
