const _Hydrate_3 = _lazyHydratedComponent(() => import("<fixtureRoot>/hydrateWhenObjectFallback.tsx?tss-hydrate=hydrateWhenObjectFallback_ff2f1d1b76&tss-hydrate-index=2"), "Hydrate_2"),
  _Hydrate_2_preload = _Hydrate_3.preload;
const _Hydrate_2 = _lazyHydratedComponent(() => import("<fixtureRoot>/hydrateWhenObjectFallback.tsx?tss-hydrate=hydrateWhenObjectFallback_bdf3670c0a&tss-hydrate-index=1"), "Hydrate_1"),
  _Hydrate_1_preload = _Hydrate_2.preload;
const _Hydrate_ = _lazyHydratedComponent(() => import("<fixtureRoot>/hydrateWhenObjectFallback.tsx?tss-hydrate=hydrateWhenObjectFallback_02e12e6487&tss-hydrate-index=0"), "Hydrate_0"),
