...
test('when creating the root route with context and routeContext', () => {
  ...
  expectTypeOf(rootRoute.useRouteContext<typeof _router>()).toEqualTypeOf<
    Accessor<{
      userId: string
    }>
  >()

  expectTypeOf(rootRoute.useRouteContext<typeof _router>)
    .parameter(0)
    .exclude<undefined>()
...
test('when creating the root route with context, routeContext, beforeLoad and a loader', () => {
  ...
  expectTypeOf(rootRoute.useRouteContext<typeof _router, string>)
    .parameter(0)
    .exclude<undefined>()
    .toHaveProperty('select')
    .toEqualTypeOf<
...
test('when creating a child route with a loader from the root route', () => {
  ...
  expectTypeOf(invoicesRoute.useLoaderData<typeof _router, string>)
    .parameter(0)
    .exclude<undefined>()
    .toHaveProperty('select')
    .toEqualTypeOf<
  ...
  expectTypeOf(invoicesRoute.useLoaderData<typeof _router>()).toEqualTypeOf<
    Accessor<
...
test('when creating a child route with search params from the root route', () => {
  ...
  expectTypeOf(invoicesRoute.useSearch<typeof _router>()).toEqualTypeOf<
    Accessor<{
      page: number
    }>
  >()

  expectTypeOf(invoicesRoute.useSearch<typeof _router, number>)
    .parameter(0)
    .exclude<undefined>()
    .toHaveProperty('select')
...
test('when creating a child route with params from the root route', () => {
  ...
  expectTypeOf(invoicesRoute.useParams<typeof _router>()).toEqualTypeOf<
    Accessor<{
      invoiceId: string
    }>
  >()

  expectTypeOf(invoicesRoute.useParams<typeof _router, number>)
    .parameter(0)
    .exclude<undefined>()
    .toHaveProperty('select')
...
test('when creating a child route with params from a parent with params', () => {
  ...
  expectTypeOf(detailsRoute.useParams<typeof _router>()).toEqualTypeOf<
    Accessor<{
      invoiceId: string
      detailId: string
    }>
  ...
  expectTypeOf(detailsRoute.useParams<typeof _router, number>)
    .parameter(0)
    .exclude<undefined>()
    .toHaveProperty('select')
    .toEqualTypeOf<
...
test('when creating a child route with search from a parent with search', () => {
  ...
  expectTypeOf(detailsRoute.useSearch<typeof _router>()).toEqualTypeOf<
    Accessor<{
      invoicePage: number
      detailPage: number
    }>
  ...
  expectTypeOf(detailsRoute.useSearch<typeof _router, number>)
    .parameter(0)
    .exclude<undefined>()
    .toHaveProperty('select')
    .toEqualTypeOf<
...
test('when creating a child route with routeContext from a parent with routeContext', () => {
  ...
  expectTypeOf(detailsRoute.useRouteContext<typeof _router>()).toEqualTypeOf<
    Accessor<{
      userId: string
      invoiceId: string
      detailId: string
  ...
  expectTypeOf(detailsRoute.useRouteContext<typeof _router, number>)
    .parameter(0)
    .exclude<undefined>()
    .toHaveProperty('select')
    .toEqualTypeOf<
...
test('when creating a child route with parseParams and stringifyParams with params in path', () => {
  ...
  expectTypeOf(invoiceRoute.useParams<typeof _router>()).toEqualTypeOf<
    Accessor<{
      invoiceId: number
    }>
  >()
...
test('when creating a child route with parseParams and stringifyParams with merged params from parent', () => {
  ...
  expectTypeOf(detailRoute.useParams<typeof _router>()).toEqualTypeOf<
    Accessor<{
      detailId: number
      invoiceId: number
    }>
...
test('when routeContext throws', () => {
  ...
  expectTypeOf(invoicesRoute.useRouteContext<typeof _router>()).toEqualTypeOf<
    Accessor<{}>
  >()
})
...
test('when creating a child route with no explicit search input', () => {
  ...
  expectTypeOf(rootRoute.useSearch<typeof _router>()).toEqualTypeOf<
    Accessor<{
      page: number
    }>
  >()

  expectTypeOf(indexRoute.useSearch<typeof _router>()).toEqualTypeOf<
    Accessor<{
      page: number
    }>
  >()

  expectTypeOf(rootRouteWithContext.useSearch<typeof _router>()).toEqualTypeOf<
    Accessor<{
      page: number
    }>
  >()
  ...
  expectTypeOf(navigate<typeof _router, '/', '/'>)
    .parameter(0)
...
test('when creating a route with a prefix and suffix', () => {
  ...
  expectTypeOf(prefixSuffixRoute.useParams<typeof _router>()).toEqualTypeOf<
    Accessor<{
      postId: string
    }>
  >()
