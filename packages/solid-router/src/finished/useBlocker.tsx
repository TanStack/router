...
function _createResolveBlockerOpts(
  opts?: UseBlockerOpts | LegacyBlockerOpts | LegacyBlockerFn,
  condition?: Solid.Accessor<boolean | any>,
): Solid.Accessor<Required<UseBlockerOpts>> {
  function inner(): UseBlockerOpts {
    if (opts === undefined) {
      return {
        shouldBlockFn: () => true,
        withResolver: false,
  ...
  return () => {
    ...
    v.enableBeforeUnload ??= true
    v.disabled ??= false
    v.withResolver ??= false

    return v as Required<UseBlockerOpts>
  }
}
...
): Solid.Accessor<TWithResolver extends true ? BlockerResolver<TRouter> : void>

export function useBlocker(
  opts?: UseBlockerOpts,
  condition?: boolean | any,
): Solid.Accessor<BlockerResolver | void> {
  const resolvedOpts = _createResolveBlockerOpts(opts, condition)
  ...
  Solid.createEffect(
    Solid.on(
      () => resolvedOpts(),
      ({ disabled, enableBeforeUnload, shouldBlockFn, withResolver }) => {
