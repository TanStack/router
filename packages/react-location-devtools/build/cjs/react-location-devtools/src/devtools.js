...
var index = require('../../react-location-lite/build/esm/index.js');
...
var _excluded = ["style"],
    ...
    _excluded4 = ["isOpen", "setIsOpen", "handleDragStart", "isLite"];
...
var ReactLocationDevtoolsPanel = /*#__PURE__*/React__default["default"].forwardRef(function ReactLocationDevtoolsPanel(props, ref) {
  ...
  var router = isLite ? index.useRouter() : reactLocation.useRouter();
  ...
  }, "Pending Matches"), (_pending = router.pending) == null ? void 0 : _pending.matches.map(function (match, i) {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      key: match.id || i,
      role: "button",
      "aria-label": "Open match details for " + match.id,
