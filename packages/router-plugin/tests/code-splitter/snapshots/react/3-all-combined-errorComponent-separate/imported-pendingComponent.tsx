...
export const Route = createFileRoute('/')({ component: lazyRouteComponent($$splitComponentImporter, "component"), pendingComponent: lazyRouteComponent($$splitPendingComponentImporter, "pendingComponent") });