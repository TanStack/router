...
import type { VanillaErrorRouteComponent, VanillaNotFoundRouteComponent } from './types'
 ...
 */
export function checkIsNotFound(error: unknown): error is import('@tanstack/router-core').NotFoundError {
 ...
 */
export function checkIsRedirect(error: unknown): error is import('@tanstack/router-core').Redirect {
