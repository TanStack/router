...
>(
  ...
  const [local, rest] = Vue.splitProps(
    Vue.mergeProps(
      {
...
export const Link: LinkComponent<'a'> = (props: any) => {
  const [local, rest] = Vue.splitProps(props, ['_asChild'])

  const [_, linkProps] = Vue.splitProps(useLinkProps(rest as unknown as any), [
    'type',
    'children',
  ])
