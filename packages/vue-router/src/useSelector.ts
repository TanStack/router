...
// Functional components can call router hooks during render without an active
// effect scope. Tie the upstream selector's cleanup to their unmount lifecycle.
