...
describe('Link', () => {
  ...
  //     const memoLocation = Vue.useMemo(() => {
  //       return {
  //         href: location.href,
  ...
  //     const childrenRef = Vue.useRef(children)
  //     const memoedRouteTree = Vue.useMemo(() => {
  ...
  //     const memoedRouter = Vue.useMemo(() => {
