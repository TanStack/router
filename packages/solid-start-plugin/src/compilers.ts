      ...
      enter(programPath) {
        ...
        programPath.traverse({
          ImportDeclaration: (path) => {
            if (path.node.source.value !== '@tanstack/solid-start') {
              return
            }

            // handle a destructured imports being renamed like "import { createServerFn as myCreateServerFn } from '@tanstack/solid-start';"
            path.node.specifiers.forEach((specifier) => {
              identifierKeys.forEach((identifierKey) => {
                ...
                // handle namespace imports like "import * as TanStackStart from '@tanstack/solid-start';"
