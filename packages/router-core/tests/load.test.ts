...
import type { AnyRouter, LoaderStaleReloadMode, RouterCore } from '../src'
...
type LoaderEntry = { handler: Loader; staleReloadMode?: LoaderStaleReloadMode }
