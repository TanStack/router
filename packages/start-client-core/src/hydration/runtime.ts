...
import type { HydrationRuntimeGate, HydrationWhen } from './types'
...
const gateRegistry = new Map<string, HydrationGateRecord>()
const resolvedGateIds = new Set<string>()
const fallbackHtmlByGateId = new Map<string, string>()
