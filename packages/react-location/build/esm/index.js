  ...
  this.load = function (opts) {
    ...
    _this5.loaderPromise = (!importer ? Promise.resolve() : importer({
      ...
      var dataPromise = !loader ? Promise.resolve().then(function () {
        ...
        var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(resolveLoader) {
...
var MatchLoader = /*#__PURE__*/function (_Subscribable3) {
  ...
  function MatchLoader(router, nextLocation) {
    ...
    _this6.loadData = /*#__PURE__*/function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_temp) {
        var _this6$matches;
    ...
    _this6.load = /*#__PURE__*/function () {
      var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(_temp2) {
        var _ref11, maxAge;
    ...
    _this6.startPending = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
...
function matchRoutes(router, currentLocation) {
  ...
  var recurse = /*#__PURE__*/function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(routes, parentMatch) {
...
function useLoadRoute() {
  ...
  return useLatestCallback( /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(navigate, opts) {
      var _navigate$from;
...
var Link = function Link(_ref16) {
  ...
  var _ref16$to = _ref16.to,
    ...
    return {};
      ...
      _ref = _ref16._ref,
      rest = _objectWithoutPropertiesLoose(_ref16, _excluded4);
  ...
  var _ref17 = isActive ? getActiveProps() : {},
      ...
      activeRest = _objectWithoutPropertiesLoose(_ref17, _excluded5); // Get the inactive props
  ...
  var _ref18 = isActive ? {} : getInactiveProps(),
      ...
      inactiveRest = _objectWithoutPropertiesLoose(_ref18, _excluded6);
...
function useMatchRoute() {
  ...
  return useLatestCallback(function (_ref19) {
    var pending = _ref19.pending,
        matchLocation = _objectWithoutPropertiesLoose(_ref19, _excluded7);
...
function MatchRoute(_ref20) {
  var children = _ref20.children,
      rest = _objectWithoutPropertiesLoose(_ref20, _excluded8);
...
export { Link, MatchRoute, MatchesProvider, Navigate, Outlet, Prompt, ReactLocation, RouteMatch, Router, RouterInstance, cleanPath, defaultParseSearch, defaultStringifySearch, functionalUpdate, matchByPath, matchRoute, matchRoutes, parsePathname, resolvePath, useLoadRoute, useLocation, useMatch, useMatchRoute, useMatches, useNavigate, useParentMatches, usePrompt, useResolvePath, useRouter, useSearch };
