...
export interface RouterHistory {
  ...
  length: number
  subscribers: Set<(location: HistoryLocation) => void>
  subscribe: (cb: (location: HistoryLocation) => void) => () => void
...
export function createHistory(opts: {
  ...
  const subscribers = new Set<(location: HistoryLocation) => void>()
  ...
  return {
    ...
    subscribers,
    subscribe: (cb: (location: HistoryLocation) => void) => {
      subscribers.add(cb)
