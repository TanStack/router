...
/**
 * Verifies that framework hydration has completed by clicking the global
 ...
 * the framework has finished hydrating.
 */
async function verifyHydration(
  ...
  // This handles the case where SSR renders the button before the framework hydrates
  await expect(async () => {
 ...
 * Use this for tests where you want to confirm framework hydration succeeded.
 */
