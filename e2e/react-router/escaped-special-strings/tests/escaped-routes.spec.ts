...
test.describe('Escaped special strings routing', () => {
  test('escaped [index] route renders at /index path', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-title')).toContainText('Escaped Index Page')
  ...
  test('escaped [route] route renders at /route path', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-title')).toContainText('Escaped Route Page')
  ...
  test('escaped [lazy] route renders at /lazy path', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-title')).toContainText('Escaped Lazy Page')
  ...
  test('escaped [_]layout route renders at /_layout path', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-title')).toContainText('Escaped Underscore Layout Page')
  ...
  test('escaped blog[_] route renders at /blog_ path', async ({ page }) => {
    ...
    await expect(page.getByTestId('page-title')).toContainText('Escaped Blog Underscore Page')
  ...
  test('URL is correct for escaped routes with underscores', async ({ page, baseURL }) => {
    await page.goto('/_layout')
