  ...
  return (
    <div>
      ...
      <p data-testid="page-description">
        This route was created using blog[_].tsx to escape the trailing underscore.
        It renders at the literal path /blog_ with the underscore preserved in the URL.
      </p>
    </div>
  )
}
