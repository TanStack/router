...
test.describe('skipRouteOnParseError', () => {
  ...
  test.describe('direct URL navigation', () => {
    ...
    test('navigating to negative number matches Catch-all (not valid integer parse)', async ({
      page,
    }) => {
      // Our numeric parser requires the string representation to match exactly
      // -123 parses to -123, but "-123" !== "-123" check passes, so this should match numeric
