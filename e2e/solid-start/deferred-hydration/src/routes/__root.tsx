      ...
      <head>
        ...
        <style>{`
          * { box-sizing: border-box; }
          ...
          [data-testid^="enhanced-"][data-testid$="-button"] { border: 0; border-radius: 999px; padding: 0.65rem 0.95rem; margin: 0.2rem 0.25rem 0.2rem 0; background: #4f46e5; color: white; font-weight: 800; cursor: pointer; box-shadow: 0 10px 28px rgba(79, 70, 229, 0.22); }
