      ...
      <head>
        ...
        <style>{`
          * { box-sizing: border-box; }
          ...
          nav a { padding: 0.55rem 0.8rem; border-radius: 999px; color: #312e81; text-decoration: none; font-weight: 800; }
          main { width: min(1100px, calc(100vw - 2rem)); margin: 0 auto; padding: 2rem 0 4rem; }
          .dh-page { display: grid; gap: 1rem; }
          .dh-hero { padding: clamp(1.5rem, 4vw, 3rem); border: 1px solid rgba(99, 102, 241, 0.18); border-radius: 2rem; background: rgba(255, 255, 255, 0.78); box-shadow: 0 24px 80px rgba(67, 56, 202, 0.14); }
          ...
          .dh-card { display: grid; gap: 0.7rem; align-content: start; padding: 1.1rem; min-height: 150px; border: 1px solid rgba(15, 23, 42, 0.1); border-radius: 1.25rem; background: rgba(255, 255, 255, 0.82); box-shadow: 0 12px 40px rgba(15, 23, 42, 0.08); }
          .dh-card h2 { margin: 0; color: #312e81; }
          .dh-card p { margin: 0; color: #64748b; line-height: 1.55; }
          .dh-card button { width: fit-content; border: 0; border-radius: 999px; padding: 0.7rem 1rem; background: #4f46e5; color: white; font-weight: 800; cursor: pointer; box-shadow: 0 10px 30px rgba(79, 70, 229, 0.24); }
          ...
          .dh-guide { display: grid; gap: 0.65rem; padding: 1rem; border: 1px solid rgba(14, 165, 233, 0.22); border-radius: 1.25rem; background: rgba(240, 249, 255, 0.82); color: #0f172a; }
          .dh-guide strong { color: #075985; }
          .dh-note { margin: 1rem 0 0.4rem; padding: 0.8rem 1rem; border-left: 5px solid #4f46e5; border-radius: 0.8rem; background: rgba(255, 255, 255, 0.72); color: #475569; line-height: 1.55; }
          .dh-note strong { color: #312e81; }
          .dh-spacer { display: grid; place-items: center; height: 120vh; margin: 1rem 0; border: 1px dashed rgba(79, 70, 229, 0.32); border-radius: 1.5rem; color: #4338ca; background: linear-gradient(180deg, rgba(238, 242, 255, 0.55), rgba(240, 253, 250, 0.75)); font-weight: 800; }
          [data-testid^="component-"][data-testid$="-button"] { border: 0; border-radius: 999px; padding: 0.65rem 0.95rem; margin: 0.2rem 0.25rem 0.2rem 0; background: #4f46e5; color: white; font-weight: 800; cursor: pointer; box-shadow: 0 10px 28px rgba(79, 70, 229, 0.22); }
