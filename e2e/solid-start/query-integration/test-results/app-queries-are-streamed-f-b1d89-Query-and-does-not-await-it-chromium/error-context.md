...
- Name: queries are streamed from the server >> direct visit - loader on server runs fetchQuery and does not await it
- Location: /Users/kylemathews/programs/router/e2e/solid-start/query-integration/tests/app.spec.ts:16:3
