...
- Name: SSR serialization adapters >> data-only
- Location: /Users/admin/repos/tanstack/router/e2e/solid-start/serialization-adapters/tests/app.spec.ts:48:3
...
Locator: getByTestId('router-isLoading')
Expected string: "false"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for getByTestId('router-isLoading')

    at awaitPageLoaded (/Users/admin/repos/tanstack/router/e2e/solid-start/serialization-adapters/tests/app.spec.ts:8:54)
    at /Users/admin/repos/tanstack/router/e2e/solid-start/serialization-adapters/tests/app.spec.ts:50:11
```
