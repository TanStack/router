...
- Name: server functions serialization adapters >> nested
- Location: /Users/admin/repos/tanstack/router/e2e/solid-start/serialization-adapters/tests/app.spec.ts:101:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:49955/server-function/nested
Call log:
  - navigating to "http://localhost:49955/server-function/nested", waiting until "load"

    at /Users/admin/repos/tanstack/router/e2e/solid-start/serialization-adapters/tests/app.spec.ts:102:16
```
