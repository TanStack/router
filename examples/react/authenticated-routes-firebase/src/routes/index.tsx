		...
		<div className="p-4 max-w-3xl mx-auto">
			...
			<section className="mb-6 p-4 bg-slate-100 dark:bg-slate-800 rounded-lg">
				...
				<p>
					...
					while other routes are public. The <code>(public)</code> folder is used purely for
					organization and doesn't affect routing.
				</p>
			</section>
			...
			<section className="mb-6">
				...
				<p className="mb-3">
					This page (<code>index.tsx</code>) serves as your public landing/sales page.
					When an authenticated user visits this route, they're automatically
					redirected to <code>/dashboard</code>.
				</p>
			</section>
			...
			<section className="mt-6">
				...
				<div className="flex gap-4">
					...
					<Link to="/dashboard" className="px-4 py-2 border border-gray-300 rounded hover:bg-gray-100 dark:hover:bg-gray-800">
						Dashboard (Protected)
					</Link>
				</div>
			</section>
